var site_settings = '<div class="ts-button">'
    ...
    +'<div class="ts-body">'
        ...
        +'<div class="ts-themes">'
            +'<a href="#" class="active" data-theme="css/theme-default.css"><img src="admin_asset/img/themes/default.jpg"/></a>'            
            +'<a href="#" data-theme="css/theme-forest.css"><img src="admin_asset/img/themes/forest.jpg"/></a>'
            +'<a href="#" data-theme="css/theme-dark.css"><img src="admin_asset/img/themes/dark.jpg"/></a>'                        
            +'<a href="#" data-theme="css/theme-night.css"><img src="admin_asset/img/themes/night.jpg"/></a>'            
            +'<a href="#" data-theme="css/theme-serenity.css"><img src="admin_asset/img/themes/serenity.jpg"/></a>'
            
            +'<a href="#" data-theme="css/theme-default-head-light.css"><img src="admin_asset/img/themes/default-head-light.jpg"/></a>'
            +'<a href="#" data-theme="css/theme-forest-head-light.css"><img src="admin_asset/img/themes/forest-head-light.jpg"/></a>'    
            +'<a href="#" data-theme="css/theme-dark-head-light.css"><img src="admin_asset/img/themes/dark-head-light.jpg"/></a>'            
            +'<a href="#" data-theme="css/theme-night-head-light.css"><img src="admin_asset/img/themes/night-head-light.jpg"/></a>'
            +'<a href="#" data-theme="css/theme-serenity-head-light.css"><img src="admin_asset/img/themes/serenity-head-light.jpg"/></a>'
        +'</div>'
        +'<div id="ts-wallpapers">'
        +'<div class="ts-title">Wallpapers</div>'
            +'<div class="ts-themes">'
                +'<a href="#" class="active" data-wall="wall_1"><img src="admin_asset/img/backgrounds/wall_1.jpg"/></a>'
                +'<a href="#" data-wall="wall_2"><img src="admin_asset/img/backgrounds/wall_2.jpg"/></a>'
                +'<a href="#" data-wall="wall_3"><img src="admin_asset/img/backgrounds/wall_3.jpg"/></a>'
                +'<a href="#" data-wall="wall_4"><img src="admin_asset/img/backgrounds/wall_4.jpg"/></a>'    
                +'<a href="#" data-wall="wall_5"><img src="admin_asset/img/backgrounds/wall_5.jpg"/></a>'

                +'<a href="#" data-wall="wall_6"><img src="admin_asset/img/backgrounds/wall_6.jpg"/></a>'
                +'<a href="#" data-wall="wall_7"><img src="admin_asset/img/backgrounds/wall_7.jpg"/></a>'
                +'<a href="#" data-wall="wall_8"><img src="admin_asset/img/backgrounds/wall_8.jpg"/></a>'
                +'<a href="#" data-wall="wall_9"><img src="admin_asset/img/backgrounds/wall_9.jpg"/></a>'    
                +'<a href="#" data-wall="wall_10"><img src="admin_asset/img/backgrounds/wall_10.jpg"/></a>'    
            +'</div>'
        +'</div>'
    +'</div>';
